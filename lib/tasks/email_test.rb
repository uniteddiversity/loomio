  ...
  describe "Invite People Mailer" do
    ...
    it "to_join_group" do
      ...
      addresses.each do |email|
        ...
        invitation = Invitation.to_join_group( recipient_email: membership_request.email,
                                                                         inviter: admin,
                                                                         group: membership_request.group )
    ...
    it "to_start_group" do
      ...
      addresses.each do |email|
        ...
        invitation = Invitation.to_start_group( recipient_email: membership_request.email,
